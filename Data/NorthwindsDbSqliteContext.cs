...
public partial class NorthwindsDbSqliteContext : DbContext
{
    public NorthwindsDbSqliteContext()
    {
    }

    public NorthwindsDbSqliteContext(DbContextOptions<NorthwindsDbSqliteContext> options)
        : base(options)
    {
    }
