...
{
    public class NorthwindsDbSqlServerRepo : INorthwindsDbRepo
    {
        private readonly NorthwindsDbSqlServerContext _context;

        public NorthwindsDbSqlServerRepo(NorthwindsDbSqlServerContext context)
        {
            _context = context;
        }
